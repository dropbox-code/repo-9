...
describe NetSuite::Records::CustomerSubsidiaryRelationship do
  ...
  describe '.get' do
    ...
    context 'when the response is successful' do
      ...
      it 'returns a CustomerSubsidiaryRelationship instance populated with the data from the response object' do
        expect(subject).to be_kind_of(NetSuite::Records::CustomerSubsidiaryRelationship)
  ...
  describe '#add' do
    ...
    let(:relationship) { NetSuite::Records::CustomerSubsidiaryRelationship.new(:is_primary_sub => true) }
  ...
  describe '#record_type' do
    it 'returns a string representation of the SOAP type' do
      expect(relationship.record_type).to eql('listRel:CustomerSubsidiaryRelationship')
    end
  end
end
